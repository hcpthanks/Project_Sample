...
article.add_url_rule('/articles/', view_func=ArticleListView.as_view('article-list.html'))

article.add_url_rule('/articles/<int:id>/', view_func=ArticleDetailView.as_view('article-detail.html'))
